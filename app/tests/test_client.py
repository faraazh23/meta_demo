...
def test_client_insights_happy_path(monkeypatch):
    ...
    import httpx
    monkeypatch.setattr(httpx.AsyncClient, "post", lambda self, *args, **kwargs: fake_oauth(*args, **kwargs))
    monkeypatch.setattr(httpx.AsyncClient, "get", lambda self, *args, **kwargs: fake_insights(*args, **kwargs))
...
def test_client_insights_auth_fail(monkeypatch):
    ...
    import httpx
    monkeypatch.setattr(httpx.AsyncClient, "post", lambda self, *args, **kwargs: bad_oauth(*args, **kwargs))
